...
class KITTI_MOT(data.Dataset):
    ...
    def __init__(self,
        ...
        # self.root = osp.join(args.data_root, 'nuScenes_pointclouds')
        self.root = osp.join(args.data_root, args.folder_name)
    ...
    def pc_loader(self, path):
        ...
        # forcing same shape for point clouds , 
        ...
        # getting error due to mismatch in pointcloud shape
